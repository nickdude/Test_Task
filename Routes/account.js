...
accountRoutes.post('/account/addaccount', (req, res) => {
      ...
      if (existAccounts[newAccountId].name == null || existAccounts[newAccountId].age == null || existAccounts[newAccountId].age == null || existAccounts[newAccountId].gender == null) {
